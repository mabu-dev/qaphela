...
class ProfileHeader extends StatelessWidget {
  ...
  final Perpetrators profile;

  ProfileHeader({Key key, this.profile}): super(key: key);
    ...
    return new Row(
      children: <Widget>[
        ...
        new Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            new Text(profile.fullNames, style: mainTextStyle),
            new Text(profile.workplaceDetails, style: subTextStyle),
          ],
        ),
      ],
    );
  ...
  Widget _buildFollowerStats() {
    return new Row(
      ...
      children: <Widget>[
        _buildFollowerStat("Followers", profile.contactDetails.primaryContactNumber),
        _buildVerticalDivider(),
        _buildFollowerStat("Following", profile.contactDetails.nextOfKinFirstname),
        _buildVerticalDivider(),
        _buildFollowerStat("Total Likes", profile.contactDetails.nextOfKinLastname),
      ],
    );
  }
